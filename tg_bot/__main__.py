...
എന്റെ ന്യൂ ഫീച്ചേർസ് ചാനലിൽ @kunjappansupportez ഇടുന്നതായിരിക്കും. സംശയങ്ങൾക്ക് @kunjappansupport എന്ന ഗ്രൂപ്പിൽ വരാവുന്നതാണ്.....

എന്നെ നോക്കി നടത്തുന്നത്  [ഇദ്ദേഹം](tg://user?id={}) ആണ് . എന്നെ നിർമിച്ചിരിക്കുന്നത് python3യിൽ 
python-telegram-bot library ഉപയോഗിച്ചാണ്.... ഞാൻ പൂർണമായും opensource ആണ്.. എന്റെ കോഡ് നിങ്ങൾക്ക് [ഇവിടെ](https://heroku.com/deploy?template=https://github.com/hopepsycho/kunjappan) കാണാവുന്നതാണ്...
എന്നെ ഉപയോഗിക്കാൻ ആവിശ്യമായ commandകൾ അറിയാൻ /help കൊടുത്താൽ മതിയാകും..
വിവരങ്ങൾക്കായി /info  ഉപയോഗിക്കാവുന്നതാണ്...

Using standard [PSY](http://telegram.dog/Kunjappanpachubot) is always gonna be easier.
എന്റെ ചേച്ചിയായ [kunjimmu](http://telegram.dog/Kunjappanpachubot) ഉപയോഗിക്കുന്നത് എല്ലായ്പ്പോഴും എളുപ്പമായിരിക്കും. മേരി ചേച്ചിക്ക് English മാത്രമേ അറിയൂ..
...
It took lots of work for [my creator](t.me/king_of_psycho) to get me to where I am now, and every donation helps \
motivate him to make me even better. All the donation money will go to a better VPS to host me, and/or beer \
(see his bio!). He's just a poor student, so every little helps!
There are two ways of paying him; [PayPal](t.me/king_of_psycho), or [Monzo](t.me/king_of_psycho)."""
...
def donate(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 682307346 and DONATION_LINK:
